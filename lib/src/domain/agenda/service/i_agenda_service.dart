...
abstract class IAgendaService {
  ...
  Future<QraAsset> createRefereeSchedule(QraAsset qraAsset);
  RepositoryResponse<String> createQraEvents(QraEvent event);
  RepositoryResponse<QraAsset> createQraFieldLeague(QraAsset event);
  Future<List<QraEvent>> getFieldsEvents(int activeId);
  Future<List<QraEvent>> getRefereesEvents(int activeId);
