...
class ScoringSystemRepositoryImpl implements IScoringSystemRepository{
  ...
  @override
  RepositoryResponse<ScoringSystem> updateScoringSystem(ScoringSystem scoringSystem) {
    return _apiClient.network.updateData(
      endpoint: updateScoringSystemPresident, 
      data: scoringSystem.toJson(), 
      converter: ScoringSystem.fromJson).validateResponse();
  }

  @override
  RepositoryResponse<ScoringSystem> createScoringSystem(ScoringSystem scoringSystem) {
  ...
  @override
  RepositoryResponse<List<ScoringSystem>> getScoringSystemByLeague(int leagueId) {
  ...
  @override
  RepositoryResponse<ScoringSystem> getScoringSystemByTournament(int tournamentId) {
