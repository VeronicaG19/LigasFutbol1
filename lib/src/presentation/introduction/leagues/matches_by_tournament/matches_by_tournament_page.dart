            ...
            return Stack(
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Text(
                                                    (state.matchesList[index]
                                                        ...
                                                        """${state.matchesList[index].shooutOutVisita == null ? ''
                                                        :"(${state.matchesList[index].shooutOutVisita})"}""",
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Text(
                                                    (state.matchesList[index]
                                                        ...
                                                        """${state.matchesList[index].shooutOutLocal == null ? ''
                                                        :"(${state.matchesList[index].shooutOutLocal})"}""",
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(
                                                        fontSize: 13,
                                                        color: Colors.black,
                ...
                : ListView.builder(
                  ...
                  Positioned(
                    ...
                    right: 0.0,
                    child: Visibility(
                      visible: state.statusTournament == 'true' && state.nameCh.isNotEmpty,
