...
class MatchesByPlayerPage extends StatefulWidget {
  const MatchesByPlayerPage({Key? key}) : super(key: key);

  static Route route() =>
      MaterialPageRoute(builder: (_) => const MatchesByPlayerPage());
...
class MatchesByPlayerContent extends StatefulWidget {
  const MatchesByPlayerContent({Key? key}) : super(key: key);
                            ...
                            Text(
                              (state.matchesList[index].fecha == null)
                                  ...
                                  : DateFormat('dd-MM-yyyy HH:mm')
                                      .format(state.matchesList[index].fecha!),
