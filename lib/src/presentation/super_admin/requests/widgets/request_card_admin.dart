...
class RequestCardAdmin extends StatelessWidget {
  ...
  const RequestCardAdmin({super.key, required this.request, this.onTap, this.onTapCancel});
  @override
      ...
      child: Column(
        ...
        children: [
          ListTile(
            ...
            subtitle:
                Text('Nombre de la liga: ${request.requestTo}', style: titleStyle),
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
                  ...
                  showDialog(
                    ...
                    builder: (contextD) {
                      return AlertDialog(
                        ...
                        content: const Text('Confirma la cancelción'),
                        actions: [
                          TextButton(
                            onPressed: (){ 
                              onTapCancel!();
