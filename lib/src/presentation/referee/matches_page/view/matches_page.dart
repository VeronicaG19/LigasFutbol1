...
class _PageContent extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<RefMatchesCubit, RefMatchesState>(
                      ...
                      Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                "Jornada ${state.matches[index].jornada}",
                                textAlign: TextAlign.left,
                                style: TextStyle(
                                    color: Colors.grey[200],
                                    fontSize: 10,
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  showModalBottomSheet(
                                    ...
                                    builder: (_) {
                                      return BlocProvider.value(
                                        value: BlocProvider.of<RefMatchesCubit>(
                                            context),
            ...
            builder: (context, state) {
              if (match.estado == 'Pendiente') {
                ...
                return ListTile(
                  ...
                  subtitle: const Text('Resgitrar goles, tarjetas y faltas'),
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                ...
                return ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            MatchesDetailPage(matchId: match.matchId ?? 0),
                      ),
                    );
                  },
                );
