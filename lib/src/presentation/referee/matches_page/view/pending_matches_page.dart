...
class PendingMatchesPage extends StatelessWidget {
  const PendingMatchesPage({Key? key}) : super(key: key);
    ...
    return BlocListener<NotificationBloc, NotificationState>(
      ...
      child: BlocConsumer<RefMatchesCubit, RefMatchesState>(
        ...
        builder: (context, state) {
          ...
          return state.otherMatchesList.isEmpty
              ? const Center(
              ...
              : ListView.builder(
                  ...
                  itemCount: state.otherMatchesList.length,
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  ...
                                  (state.otherMatchesList[index].fechayCampo
                                          .isEmpty)
                                      ? "Fecha pendiente por agendar"
                                      : state
                                          .otherMatchesList[index].fechayCampo,
                                ...
                                Text(
                                  "Jornada ${state.otherMatchesList[index].jornada}",
                                  textAlign: TextAlign.left,
                                  style: TextStyle(
                                      color: Colors.grey[200],
                                      fontSize: 10,
                              ...
                              children: [
                                Column(children: [
                                  SizedBox(
                                    width: 200,
                                    child: Text(
                                      state.otherMatchesList[index].partido,
                                  ...
                                  SizedBox(
                                    width: 100,
                                    child: Text(
                                      state.otherMatchesList[index].estado,
                                      style: TextStyle(
                                          fontSize: 11,
