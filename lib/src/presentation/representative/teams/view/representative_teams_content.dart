...
class RepresentativeTeamsContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final teamManager = context.read<AuthenticationBloc>().state.teamManager;
    return BlocBuilder<RepresentativeTeamsCubit, RepresentativeTeamsState>(
        ...
        if (state.screenStatus == ScreenStatus.loading) {
          ...
          return state.teamList.isNotEmpty
                ...
                actions: [
                  TextButton(
                    onPressed: () async {
                      Navigator.push(
                          context,
                          RequestNewTeamPage.route(
                              BlocProvider.of<RepresentativeTeamsCubit>(context)
                          )
                      );
                    },
                    child: Container(
            ...
            body: ListView.builder(
                            ...
                            children: <Widget>[
                              TextButton(
                                  onPressed: () {
                                    ...
                                    //   MaterialPageRoute(
                                    //     builder: (context) =>
                                    //         RepresentativeMainPage(
                                    //             teamId: state.teamList[index].teamId
                                    //         ),
                                    //   ),
                                    // );
                                  },
              ...
              : const Center(child: Text("No tiene equipos creados."));
        }
      },
    );
  }
