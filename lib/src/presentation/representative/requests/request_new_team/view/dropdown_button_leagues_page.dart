...
import 'package:ligas_futbol_flutter/src/presentation/representative/requests/request_new_team/cubit/request_new_team_cubit.dart';
        ...
        listener: (context, state) {
          ...
          if (state.formzStatus == FormzStatus.submissionFailure) {
            ScaffoldMessenger.of(context)
              ..hideCurrentSnackBar()
              ..showSnackBar(
                const SnackBar(content: Text('Error al enviar solicitud'), duration: Duration(seconds: 5)),
              );
          }
        },
            ...
            children:  [
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2(
                            ...
                            onChanged: (value) {
                              ...
                              context.read<RequestNewTeamCubit>().onLeagueIdChange(value!);
                              context.read<RequestNewTeamCubit>().availableCategoriesByLeagueId(value.leagueId);
                            },
              ...
              GestureDetector(
                onTap: state.formzStatus.isValidated
                    ? () async {
                  context.read<RequestNewTeamCubit>().sendRequestNewTeam(partyId: personId);
                } : null,
                child: Container(
      ...
      builder: (context, state) {
        return TextFormField(
          ...
          decoration: InputDecoration(
            ...
            errorText: state.teamName.invalid ? "Escriba el nombre del equipo" : null,
          ),
