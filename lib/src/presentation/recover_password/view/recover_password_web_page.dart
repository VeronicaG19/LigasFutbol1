          ...
          child: Center(
              child: Padding(
                  padding: EdgeInsets.only(
                      right: screenSize.width / 4, left: screenSize.width / 4),
                  child: Container(
      ...
      listener: (context, state) {
        if (state.status.isSubmissionFailure) {
          ...
          ScaffoldMessenger.of(context)
            ...
            ..showSnackBar(
              SnackBar(
                  content: Text(message), duration: const Duration(seconds: 9)),
            );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Icon(Icons.security, size: 100, color: Colors.white60),
            const SizedBox(
              height: 1.0,
            ),
            Expanded(
