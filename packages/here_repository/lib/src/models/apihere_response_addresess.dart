...
class ApiHereResponseAddresses extends Equatable {
   const  ApiHereResponseAddresses({
    ...
    static const empty = ApiHereResponseAddresses(response: null);
...
class Response extends Equatable {
    ...
    factory Response.fromJson(Map<String, dynamic> json){ 
        return Response(
            ...
            view: json["View"] == null ? [] : List<View>.from(json["View"]!.map((x) => View.fromJson(x))),
        );
    }

    Map<String, dynamic> toJson() => {
        "MetaInfo": metaInfo?.toJson(),
        "View": view.map((x) => x?.toJson()).toList(),
    };
...
class Result extends Equatable {
    ...
    factory Result.fromJson(Map<String, dynamic> json){ 
        return Result(
            ...
            matchQuality: json["MatchQuality"] == null ? null : MatchQuality.fromJson(json["MatchQuality"]),
    ...
    @override
    List<Object?> get props => [
    relevance, matchLevel, matchQuality, matchType, location, ];
}
...
class Location extends Equatable {
    ...
    factory Location.fromJson(Map<String, dynamic> json){ 
        return Location(
            ...
            displayPosition: json["DisplayPosition"] == null ? null : DisplayPosition.fromJson(json["DisplayPosition"]),
            navigationPosition: json["NavigationPosition"] == null ? [] : List<DisplayPosition>.from(json["NavigationPosition"]!.map((x) => DisplayPosition.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "NavigationPosition": navigationPosition.map((x) => x?.toJson()).toList(),
    ...
    @override
    String toString(){
        return "$locationId, $locationType, $displayPosition, $navigationPosition, $mapView, $address, ";
    }

    @override
    List<Object?> get props => [
    locationId, locationType, displayPosition, navigationPosition, mapView, address, ];
}
...
class Address extends Equatable {
    ...
    factory Address.fromJson(Map<String, dynamic> json){ 
        return Address(
            ...
            additionalData: json["AdditionalData"] == null ? [] : List<AdditionalDatum>.from(json["AdditionalData"]!.map((x) => AdditionalDatum.fromJson(x))),
        );
    }
    ...
    @override
    String toString(){
        return "$label, $country, $state, $city, $district, $street, $houseNumber, $postalCode, $additionalData, ";
    }

    @override
    List<Object?> get props => [
    label, country, state, city, district, street, houseNumber, postalCode, additionalData, ];
}
...
class MapView extends Equatable {
    ...
    factory MapView.fromJson(Map<String, dynamic> json){ 
        return MapView(
            topLeft: json["TopLeft"] == null ? null : DisplayPosition.fromJson(json["TopLeft"]),
            bottomRight: json["BottomRight"] == null ? null : DisplayPosition.fromJson(json["BottomRight"]),
        );
    }
...
class MatchQuality extends Equatable {
    ...
    factory MatchQuality.fromJson(Map<String, dynamic> json){ 
        return MatchQuality(
            street: json["Street"] == null ? [] : List<double>.from(json["Street"]!.map((x) => x)),
            houseNumber: json["HouseNumber"],
        );
    }
